  ...
  return {
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          name: "Farflower Land",
          id: "com.farflower-land",
          description:
            "🧑‍🌾 Install Farflower Land for a seamless farming experience. Enjoy full-screen action, easy access, and exclusive features!",
          short_name: "Farflower Land",
